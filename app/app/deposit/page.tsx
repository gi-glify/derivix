  ...
  return <main className="mx-auto max-w-6xl px-5 py-8 sm:px-8">
    ...
    <div className="grid items-start gap-6 lg:grid-cols-2">
      <section className={card}><div className="flex items-center justify-between"><h2 className="text-xl font-semibold">New payment</h2><MpesaMark/></div>
        <p className="mt-4 text-sm leading-6 text-brand-muted">{purpose || 'The payment purpose will appear here when collection is configured.'} Real payments do not fund or change virtual practice credits.</p>
      ...
      <section className={card}><h2 className="text-xl font-semibold">Payment progress</h2>{active?<>
        ...
        {active.status==='COMPLETED'&&<p className="mt-4 text-sm text-brand-muted">Your payment receipt is recorded against your account. Virtual practice balances are unchanged.</p>}
